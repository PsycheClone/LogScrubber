...
public class StatisticsExposingMBean extends NotificationBroadcasterSupport implements DynamicMBean {
     ...
     */
    public static final String DEFAULT_MBEAN_NAME = "org.singular.parser.perf4jClasses.helper:type=StatisticsExposingMBean,name=Perf4J";
    /**
     * The type of the Notifications sent when a statistics value is outside of the acceptable range.
     */
    public static final String OUT_OF_RANGE_NOTIFICATION_TYPE = "org.singular.parser.perf4jClasses.helper.threshold.exceeded";
