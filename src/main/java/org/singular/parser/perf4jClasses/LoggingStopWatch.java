...
public class LoggingStopWatch extends StopWatch {
     ...
     * {@link org.singular.parser.perf4jClasses.log4j.JmxAttributeStatisticsAppender} in the logging configuration to be notified when
     ...
     * @see org.singular.parser.perf4jClasses.log4j.JmxAttributeStatisticsAppender#getNotificationThresholds()
     */
